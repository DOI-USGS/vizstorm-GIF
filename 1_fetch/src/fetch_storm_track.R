...
#' @param cfg the list that contains the 8-digit character ID identifying a storm by the codes used at https://www.nhc.noaa.gov/gis/archive_besttrack.php?year=2018. The components are a 2-digit ocean ID ('al' or 'ep'), a 2-digit storm number (counts up from 01 throughout the year), and a 4-digit year. Go to the NHC website to identify the right code.
#' year: 2017
fetch_storm_track <- function(ind_file, cfg) {
